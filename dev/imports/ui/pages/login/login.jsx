...
export class LoginPage extends Component {
	...
	onClose(e) {
		e.preventDefault();
		FlowRouter.go("private_home", mergeObjects(this.props.data.routeParams, {  }));
	}
	...
	<div className="page-container container" id="content">
		<form id="login_form" className="account-form" role="form" onSubmit={this.onLoginWithPassword}>
			...
			<button id="login-with-facebook" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithFacebook}>
				<span className="fa fa-facebook-official">
				</span>
				&nbsp;Sign in with Facebook
			</button>
			<button id="login-with-linkedin" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithLinkedin}>
